...
# Load YOLOv8 model (make sure this file exists or use pretrained 'yolov8n.pt')
    ...
    for r in results.boxes:
        ...
        if cls_id == 0 and conf > 0.5:  # class 0 is 'person'
            ...
            for top, right, bottom, left in face_locations:
                ...
                label = f"{gender}, {age}"
                cv2.putText(frame, label, (x1 + left, y1 + top - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
